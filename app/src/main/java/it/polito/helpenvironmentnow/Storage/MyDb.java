...
public class MyDb {
    ...
    public void storeJsonObject(JSONObject jsonObject, JsonTypes type) {
        StoredJson currentJson = new StoredJson();
        currentJson.id = 0; // 0 means that the id will be auto-generated by Sqlite
        // In the database I insert the string corresponding to the enum constant. For example for
        // the JsonTypes.CLASSIC I insert "c" by calling getType() as I have done below.
        // When I extract from the database, if I want to get the JsonTypes from the string I have to
        // do it manually as I have done in UploadWorker class in method getJsonTypes(...).
        currentJson.type = type.getType();
